export const SITE = {
  ...
  aboutTitle: 'Une séance simple, claire et respectueuse.',
  aboutText: 'Chaque séance est adaptée à votre rythme, dans une ambiance calme et une écoute attentive. Le massage proposé est un massage de bien-être et de relaxation, sans objectif médical ni thérapeutique.',
  contactNote: 'Réponse rapide — sur rendez-vous uniquement.',
  framework: ['Massage bien-être / relaxation uniquement', 'Séance sur rendez-vous', 'Cadre respectueux, clair et sans ambiguïté', 'Aucune promesse médicale'],
  services: [
    {tag:'Relaxation', title:'Massage bien-être', text:'Un moment de détente globale pour relâcher les tensions et retrouver un souffle plus calme.'},
    {tag:'Présence', title:'Massage intuitif', text:'Une séance personnalisée selon vos besoins, votre fatigue et votre sensibilité du moment.'},
